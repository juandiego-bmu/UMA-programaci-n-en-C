...
void leer_datos(struct Datos * d1){
    ...
    d1->elm = (int *)malloc(d1->capacidad*sizeof(int)); //creo un espacio con una capacidad especifica para el puntero d1->elm
